...
\begin{itemize}
  ...
  \item \textbf{Chapter 4: Methods} details the core models used in our study, including the principles, architectures, and key components of YOLOv11 (detector) and DeepSORT (tracker). The chapter presents our detect–track–count pipeline with three Kalman state-space configurations (CV-8D, CA-12D, and Phys-5D), introduces the scene and imaging model with 2D planar trajectory visualization, and defines comprehensive MOT and counting metrics for evaluation.
