...
JDE addresses TBD limitations by integrating object detection and Re-ID (appearance feature learning) into a unified network for joint training, aiming to improve efficiency and enhance tracking via shared feature learning \cite{173}\cite{132}.
