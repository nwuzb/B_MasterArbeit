...
% --------------------------------------- Phys-6D ------------------------------------------------------------
\subsubsection{5D Physics-Constrained Model (Phys-6D)}
...
\textbf{System Integration:} The combination of YOLOv11m detector + Phys-6D tracker + virtual counting band achieves state-of-the-art counting accuracy with MAPE=2.24\%. Detailed analysis and interpretation of these results are provided in Chapter~6.
